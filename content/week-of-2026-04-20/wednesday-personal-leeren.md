...
Lo que me deja pensando es la oportunidad perdida. Tenemos la capacidad. Tenemos la gente. Tenemos la infraestructura. Nos falta decidir aplicarla acá.
...
```json
{
  ...
  "slides": [
    ...
    {
      "number": "REGIÓN",
      "headline": "Cada país ha avanzado a su modo",
      "body": "México: Pulppo automatiza el 75% del trabajo operativo del corredor. Panamá: Acobir MLS con 400+ agencias consolidadas. El Salvador: primera ley de IA de Latinoamérica.",
      "accentColor": "#F59E0B"
    },
    {
      "number": "🇨🇷 HOY",
